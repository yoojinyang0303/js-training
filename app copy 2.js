...
//       localStorage.setItem("mode", toggleBtn.toggle);
//     } else {
...
//     return !1;
//   } else {
//     const toggleBtn = document.getElementsByClassName("active");
...
//   let toggleStatus = button.attributes.toggle.value;

//   if (toggleStatus == "active") {
//     button.setAttribute("toggle", "active");
//     toggleInterval("");
//   } else {
//     button.setAttribute("toggle", "active");
